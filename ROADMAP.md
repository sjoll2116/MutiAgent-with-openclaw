...
> 三省执行智能体集群的骨架：十二部制 + 协调中枢分拣 + 实时看板 + 完整工作流。

- [x] 十二部制 Agent 架构（协调中枢 + 中书·门下·尚书 + 户礼兵刑工 + 资源调配员 + 早朝官）
...
- [ ] Linear 适配器 —— Linear 项目同步到三省执行智能体集群
- [ ] GitHub Issues 双向同步
- **难度**：⭐⭐⭐
