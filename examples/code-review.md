...
| # | 子任务 | 派发部门 | 说明 |
|---|--------|----------|------|
| 1 | 代码安全扫描 | ⚔️ 代码架构师 | 逐文件审查，标记安全问题 |
| 2 | 合规与最佳实践检查 | ⚖️ 质量保证师 | 对照 OWASP Top 10 检查合规性 |
| 3 | 修复方案输出 | ⚔️ 代码架构师 | 针对每个问题给出修复代码 |
...
**安全审查引擎批语：** *"方案合理。代码架构师负责工程侧审查，质量保证师负责合规侧审查，分工明确。注意质量保证师需出具 OWASP 逐项对照表，不能只写'基本合规'。审查通过。"*

---

## ⚔️ 各部执行结果

### 代码架构师 · 代码安全扫描（耗时 5 分钟）
...
**质量保证师结论：** 6/10 项需要处理，其中 2 项不合规（A02、A03），需立即修复。
...
安全审查引擎首轮即审查通过，代码架构师和质量保证师分工明确：代码架构师负责代码层面扫描和修复，质量保证师负责合规框架对照。
